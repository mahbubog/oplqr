          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input id="password" type="password" placeholder="Enter your password" className="mt-1 rounded-xl" />
              </div>
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link to="/register" className="text-violet-600 hover:underline font-semibold">
                  Sign up
                </Link>
              </p>
            </div>
