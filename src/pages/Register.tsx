      ...
      <div className="relative w-full max-w-md">
        <Card className="shadow-2xl border-0 bg-white/95 backdrop-blur-sm rounded-3xl">
          ...
          <CardContent className="space-y-6">
            <Button className="w-full bg-white text-gray-900 border border-gray-300 hover:bg-gray-50 py-3 rounded-xl shadow-lg">
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input id="name" type="text" placeholder="Enter your full name" className="mt-1 rounded-xl" />
              </div>
              ...
              <div>
                ...
                <Input id="password" type="password" placeholder="Create a password" className="mt-1 rounded-xl" />
              </div>
              
              <div>
                <Label htmlFor="confirmPassword">Confirm Password</Label>
                <Input id="confirmPassword" type="password" placeholder="Confirm your password" className="mt-1 rounded-xl" />
              </div>
              
              <Button className="w-full bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-700 hover:to-fuchsia-700 text-white py-3 rounded-xl shadow-lg">
                Create Account
              </Button>
            </div>
