        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Create, customize, and track QR codes for your business needs. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="mailto:support@qrgen.com" className="text-gray-400 hover:text-white transition-colors">support@qrgen.com</a></li>
            </ul>
          </div>
        </div>
